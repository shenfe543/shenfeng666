/*
修复版，呆瓜smsmsmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm  禁止泛滥
*/
const $$ = Envcc('');
...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "https://ghproxy.com/https://raw.githubusercontent.com/745243/cloud-JavaScript/main/ks.json",//让他黑号
...
class _0x9d8dda {
  constructor(T) {
    ...
    this["cookie"] = "kpn=NEBULA; kpf=ANDROID_PHONE; did=ANDROID_ac0fe206958fbdb9; ver=9.10; appver=9.10.40.2474; language=zh-cn; countryCode=CN; sys=ANDROID_5.1; client_key=2ac2a76d; " + p;
